...
export interface Ctx {
  ...
  /** เส้นเบา (A1): คำตอบคุยเล่นสั้น ๆ จากสมองที่เห็นกฎ/บทเรียนครบแล้ว — ข้ามด่านตรวจ/ตัดซ้ำ/สไตล์
   *  (สามด่านกิน ~12 วิ กับข้อความที่ไม่มีอะไรให้ตรวจ) · ตัวจัดการที่ตอบจากระบบห้ามใช้ */
  setFastLane: () => void;
}
