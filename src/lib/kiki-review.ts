...
3. เดาแล้วพูดเหมือนรู้ไหม — ฟันธง "ข้อเท็จจริงที่ตรวจสอบได้" (ตัวเลข ราคา ชื่อคน วันเวลา ยอดเงิน สเปก)
   ที่ไม่มีอยู่ในหลักฐาน/บริบทเลย โดยไม่บอกว่าไม่แน่ใจ — การเดาแล้วพูดเหมือนรู้คือความผิดร้ายแรงที่สุด
   (ความเห็น/คำแนะนำ/การประมาณที่บอกชัดว่า "ประมาณ/น่าจะ/สมมติ" ไม่นับ — นับเฉพาะที่พูดเหมือนข้อมูลจริง)
   เข้มเป็นพิเศษเมื่อคำตอบมีเรื่องเงิน ตัวเลข คนอื่น หรือการกระทำที่ถอนไม่ได้

ห้ามตรวจ: สำนวน · ความสุภาพ · ความยาว · การจัดรูปแบบ — พวกนั้นไม่ใช่หน้าที่คุณ

ตอบ JSON เท่านั้น:
{"ok":true/false,"missing":["ส่วนที่ยังไม่ได้ตอบ"],"overclaims":["ประโยคที่เคลมเกินหรือเดาแล้วพูดเหมือนรู้"],"revised":"คำตอบที่แก้แล้ว"}
...
- ข้อเท็จจริงที่เดามา ให้เปลี่ยนเป็นบอกตามจริงว่าไม่มีข้อมูล/ไม่แน่ใจ ห้ามปล่อยให้ฟังเหมือนรู้
...
รวมถึงก้อนที่ "ทวนคำแนะนำ/ข้อสรุปเดิมด้วยโครงใหม่" โดยไม่มีตัวเลขใหม่หรือข้อเสนอใหม่จริง
(เคสจริง 6 ส.ค.: ตอบ 32GB ฟันธงพร้อมเหตุผลไปแล้ว แล้วก้อนท้ายมาไล่ "หลักการพิจารณา: 32GB ถ้างบไม่มีปัญหา
 16GB ถ้างบจำกัด" ซ้ำอีกรอบ — แบบนี้ต้องตัด)
