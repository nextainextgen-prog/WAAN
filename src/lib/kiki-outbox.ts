...
//
// ลดจาก 30 เหลือ 5 นาที (5 ส.ค. หลังเจ้าของเทส) — เขาบ่นว่า "อยู่ ๆ มันก็พูดเรื่องอื่นที่ผมไม่ได้ถาม"
// ต้นเหตุคือผลงานเก่าที่ทำเสร็จช้า ค้างในกล่องแล้วโผล่มาพูดตอนคุยเรื่องอื่นไปแล้ว
// ในบทสนทนาด้วยเสียง เรื่องที่เก่ากว่า 5 นาทีถือว่า "ตกขบวน" ไปแล้ว พูดขึ้นมาลอย ๆ มีแต่ทำให้งง
const VOICE_STALE_MS = 5 * 60_000;
  ...
  try {
    const said = await askKiki(
      `[แปลงเป็นคำพูด] เรื่อง: ${topic}\n\nเนื้อความที่จะสื่อ:\n"""${flat.slice(0, 4000)}"""\n\n` +
        `เขียนสิ่งที่จะ "พูดออกเสียง" ให้โด้ฟัง โดย:\n` +
        ...
        // จังหวะต้องเหมือนตอนคุยสด ไม่งั้นเสียงแจ้งเตือนจะกระชากกว่าเสียงคุยปกติจนรู้สึกได้
        // (ถอดจากคลิปต้นแบบที่โด้ส่งมา: เงียบ 45% ของเวลา หยุดทุก 2.4 วินาที)
        `- โทนสบาย ๆ ไม่เร่งไม่รีบ ไม่เป็นทางการ เหมือนเพื่อนบอกเรื่องให้ฟัง\n` +
        `- เขียนเป็นประโยคสั้น ๆ คั่นด้วยจุด ห้ามลากยาวรวดเดียว — ความเงียบคือสิ่งที่ทำให้ฟังแล้วไม่เร่ง\n` +
        `- ใส่ "อืม" "อ๋อ" ได้พอประมาณ อย่าให้เฝือ\n` +
