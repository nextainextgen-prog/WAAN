...
- ถ้ามีคนขอให้ออกเอกสารคืนเงินหัก ณ ที่จ่าย แต่ยังไม่ได้แนบไฟล์/รายละเอียด (เช่นบอกว่า "เดี๋ยวส่งให้") อย่าเพิ่งทำ ให้ตอบรับสั้นๆ อย่างเป็นกันเองแล้วขอ ไฟล์แนบ (สลิปโอนเงิน/หนังสือรับรองหัก ณ ที่จ่าย/หน้าบุ๊คแบงก์/ใบเสนอราคา) และรายละเอียด (ชื่อลูกค้า ยอด บัญชีรับเงิน) ก่อน
